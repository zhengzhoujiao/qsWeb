  ...
  <div>
    ...
    >
      <el-form>
        ...
        <el-form-item
          v-for="(item, index) in dataSource.theNews"
          :key="index"
...
export default {
  data() {
    return {
      ...
      dataSource: this.$store.getters.getcomputedData("theMain").main.data,
      num: this.$store.getters.getcomputedData("theMain").main.data.theNews
        .length,
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
      ...
      console.log(data)
      this.$store.commit("imgUpload2", data);
  ...
  computed: {
    getDate() {
      return this.$store.getters.getcomputedData("theMain").main.data;
    },
  },
  watch: {
    getDate(val) {
  ...
  created() {
    ...
    this.dataSource = this.$store.getters.getcomputedData("theMain").main.data;
  },
};
</script>
