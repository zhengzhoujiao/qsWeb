...
export default {
  data() {
    return {
      dataSource: this.$store.getters.getcomputedData("theLunbo2").main.data,
      num: this.$store.getters.getcomputedData("theLunbo2").main.data
        .length,
  ...
  computed: {
    getDate() {
      return this.$store.getters.getcomputedData("theLunbo2").main.data;
    },
  },
  watch: {
    getDate(val) {
  ...
  created() {
    this.dataSource = this.$store.getters.getcomputedData("theLunbo2").main.data;
  },
};
</script>
