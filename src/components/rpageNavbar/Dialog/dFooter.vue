  ...
  <div>
    ...
    >
      <el-form>
        ...
        <el-row>
          <el-col>
            <el-form-item label="宣传语言" :label-width="formLabelWidth">
              <el-input
                v-model="dataSource.idea"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="热线" :label-width="formLabelWidth">
              <el-input
                v-model="dataSource.hotPhone"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
...
export default {
  data() {
    return {
      ...
      dataSource: this.$store.getters.getcomputedData("theFooter").main.data,
  ...
  computed: {
    getDate() {
      return this.$store.getters.getcomputedData("theFooter").main.data;
    },
  },
  watch: {
    getDate(val) {
  ...
  created() {
    ...
    this.dataSource = this.$store.getters.getcomputedData("theFooter").main.data;
  },
};
</script>
